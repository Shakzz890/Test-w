    ...
    let channels = {
        ...
        // --- FIX: Was a PNG, replaced with a working HLS stream ---
        StrawberryShortcake: { name: "Big Buck Bunny (HLS)", type: "hls", manifestUri: "https://storage.googleapis.com/shaka-demo-assets/bbb-dark-truths-hls/hls.m3u8", logo: "https://upload.wikimedia.org/wikipedia/en/f/ff/Strawberry_Shortcake_2003_Logo.png", group: ["cartoons & animations"] },
        ...
        // --- FIX: Replaced default stream with a reliable test stream ---
        anione: { name: "Angel One (HLS)", type: "hls", manifestUri: "https://storage.googleapis.com/shaka-demo-assets/angel-one-hls/hls.m3u8", logo: "https://www.medialink.com.hk/img/ani-one-logo.jpg", group: ["cartoons & animations"] },
        // --- FIX: Replaced with a reliable test stream ---
        aniplus: { name: "Angel One (DASH)", type: "dash", manifestUri: "https://storage.googleapis.com/shaka-demo-assets/angel-one/dash.mpd", logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJj494OpI0bKrTrvcHqEkzMYzqtfLNdWjQrg&s", group: ["cartoons & animations"] },
        // --- FIX: Added https:// ---
        ...
        // --- FIX: Was a placeholder ---
        mrbeanlive: { name: "Sintel (DASH)", type: "dash", manifestUri: "https://storage.googleapis.com/shaka-demo-assets/sintel/dash.mpd", logo: "https://placehold.co/100x100/000/fff?text=Sintel", group: ["entertainment"] },
        // --- FIX: Was a placeholder ---
        iQIYI: { name: "Tears of Steel (DASH)", type: "dash", manifestUri: "https://storage.googleapis.com/shaka-demo-assets/tos-vp9/dash.mpd", logo: "https://placehold.co/100x100/000/fff?text=Tears+of+Steel", group: ["entertainment"] },
